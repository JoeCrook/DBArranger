...
def createDI(newFileName, newDI):
    ...
    DIWriter.writerow([newDI["Name"]+"\AccessLevel",newDI["Group"],newDI["Comment"] + " - AccessLevel","No","No","0","No","No","0","0","","900","0","9999","0","1","Off","0","1","Off","0","1","Off","0","1","Off","0","1","Off","0","1","Off","0","1","0","Off","0","1","Min",newDI["Comment"] + " - AccessLevel","0","0","0","0","0","0","0","0","","","","","","","","","No"])
    return
